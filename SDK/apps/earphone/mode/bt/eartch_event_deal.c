...
#pragma bss_seg(".eartch_event_deal.data.bss")
#pragma data_seg(".eartch_event_deal.data")
#pragma const_seg(".eartch_event_deal.text.const")
#pragma code_seg(".eartch_event_deal.text")
#endif
//===========================================================//
...
#if 0//TCFG_EARTCH_EVENT_HANDLE_ENABLE
//========================================================================================//
//入耳检测UI控制流程:
//1.控制音乐播放条件:
...
{
    bt_cmd_prepare(USER_CTRL_TEST_KEY, 1, &key); //
}
