...
#define TCFG_AUDIO_ANC_AVC_ENABLE                 0                // 音量自适应
...
#define TDM_WORK_MODE                             0                // Work Mode
#define TDM_SLOT_NUM                              2                // Channels
#define TCFG_TDM_RX_ROLE                          1                // 主从配置
#define TCFG_TDM_RX_PORT_MCLK                     IO_PORTG_03      // MCLK_IO
#define TCFG_TDM_RX_PORT_BCLK                     IO_PORTG_04      // BCLK_IO
#define TCFG_TDM_RX_PORT_WCLK                     IO_PORTG_05      // WCLK_IO
#define TCFG_TDM_RX_PORT_DATA                     IO_PORTG_06      // DATA_IO
#define TCFG_TDM_TX_ROLE                          0                // 主从配置
#define TCFG_TDM_TX_PORT_MCLK                     IO_PORTB_07      // MCLK_IO
#define TCFG_TDM_TX_PORT_BCLK                     IO_PORTB_04      // BCLK_IO
#define TCFG_TDM_TX_PORT_WCLK                     IO_PORTB_05      // WCLK_IO
#define TCFG_TDM_TX_PORT_DATA                     IO_PORTB_06      // DATA_IO
