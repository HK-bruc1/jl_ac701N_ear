...
#pragma bss_seg(".tuya_demo.data.bss")
#pragma data_seg(".tuya_demo.data")
#pragma const_seg(".tuya_demo.text.const")
#pragma code_seg(".tuya_demo.text")
#endif
/*********************************************************************************************
...
#define TUYA_CONNECTION_UPDATE_ENABLE			1 ///0--disable, 1--enable
//当前请求的参数表index
