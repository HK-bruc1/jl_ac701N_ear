...
#pragma bss_seg(".mpu9250.data.bss")
#pragma data_seg(".mpu9250.data")
#pragma const_seg(".mpu9250.text.const")
#pragma code_seg(".mpu9250.text")
#endif
...
u8 mpu9250_init1(void *param)//bypass模式读取ak8963数据
{
    ...
    mpu_i2c_buf_read(MPU9250_ADDRESS_W, MPU_DEVICE_ID_REG, &temp_data, 1); //读取MPU6500的ID
