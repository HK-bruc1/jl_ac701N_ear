...
#pragma bss_seg(".qmi8658c.data.bss")
#pragma data_seg(".qmi8658c.data")
#pragma const_seg(".qmi8658c.text.const")
#pragma code_seg(".qmi8658c.text")
#endif
...
u8 qmi8658_sensor_init(void *priv)
{
    ...
    spi_cs_init();
    spi_init(get_hw_spi_config(qmi8658_info->spi_hdl));
#else
    //I3C
#endif
