...
#pragma bss_seg(".sh3001.data.bss")
#pragma data_seg(".sh3001.data")
#pragma const_seg(".sh3001.text.const")
#pragma code_seg(".sh3001.text")
#endif
/******************************************************************
...
{
    unsigned char regData[2] = {0};
    unsigned short int u16IntVal, u16IntTemp;
...
#else//spi interface
    spi_cs_init();
    spi_init(get_hw_spi_config(sh3001_info->spi_hdl));
#endif
//int module io init
