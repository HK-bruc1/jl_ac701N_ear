...
#if (!CONFIG_DOUBLE_BANK_ENABLE) || (!CONFIG_ONLY_GRENERATE_ALIGN_4K_CODE) || (!CONFIG_DB_UPDATE_DATA_GENERATE_EN)
#ERROR  "tuya OTA 需要开启这些功能"
#endif
...
{
    TAL_PR_INFO("tuya_ble_evt_callback %d", p_event->type);
    switch (p_event->type) {
...
OPERATE_RET app_config_info_set(VOID_T)
{
    ...
    tal_common_info.p_sdk_version       = (UINT8_T *)TUYA_SDK_VERSION;
    tal_common_info.p_kernel_version    = (UINT8_T *)TUYA_KERNEL_VERSION;
