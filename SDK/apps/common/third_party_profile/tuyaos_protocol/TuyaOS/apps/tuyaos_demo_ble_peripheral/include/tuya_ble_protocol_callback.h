...
// #define TY_DEVICE_NAME        "JL_TyOS"
// #define TY_DEVICE_PID         "xpqe28od" //oem no use
// #define TY_DEVICE_MAC         "DC234DC44623"
// #define TY_DEVICE_DID         "tuyaa9b25fd8d348" //16Bytes
// #define TY_DEVICE_AUTH_KEY    "W6ixHRwUdusWcDW3SVvzSV9NezcBmqi1" //32Bytes

#define TY_DEVICE_NAME        "TWS_NEW"
#define TY_DEVICE_PID         "1nlmaikj" //oem no use
#define TY_DEVICE_MAC         "DC23532A208B"
#define TY_DEVICE_DID         "uuid5c943cec84d6" //16Bytes
#define TY_DEVICE_AUTH_KEY    "0xqMcQFw9AmnWMVaauAyUIvTIO69IZWP" //32Bytes
#endif
...
typedef enum {
    ...
    APP_EVT_3,
    APP_EVT_4,
    APP_EVT_AUTH_FLASH_SAVE,
    APP_EVT_SYS_FLASH_SAVE,
    APP_EVT_TWS_SYNC_RECV,
    APP_EVT_GPT_RAW_DATA_REPORT,
} custom_evtid_t;
