 ...
 * @return VOID
 */
STATIC VOID __tuya_list_add(IN CONST P_LIST_HEAD pNew, IN CONST P_LIST_HEAD pPrev, \
 ...
 * @return VOID
 */
STATIC VOID __tuya_list_del(IN CONST P_LIST_HEAD pPrev, IN CONST P_LIST_HEAD pNext)
{
    pNext->prev = pPrev;
    pPrev->next = pNext;
}
...
{
    __tuya_list_add(pNew, pHead, pHead->next);
}
...
{
    __tuya_list_add(pNew, pHead->prev, pHead);
}
...
{
    __tuya_list_del(pEntry->prev, pEntry->next);
}
