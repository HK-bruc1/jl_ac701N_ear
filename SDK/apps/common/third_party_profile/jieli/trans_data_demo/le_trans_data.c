...
#pragma bss_seg(".le_trans_data.data.bss")
#pragma data_seg(".le_trans_data.data")
#pragma const_seg(".le_trans_data.text.const")
#pragma code_seg(".le_trans_data.text")
#endif
/*********************************************************************************************
...
#endif
bool gatt_client_check_ios_config(u8 mode);
...
void ble_profile_init(void)
{
    ...
    ble_sm_setup_init(IO_CAPABILITY_NO_INPUT_NO_OUTPUT, SM_AUTHREQ_SECURE_CONNECTION | SM_AUTHREQ_BONDING, 7, TRANS_TCFG_BLE_SECURITY_EN);
#else
