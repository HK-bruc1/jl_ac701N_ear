...
#pragma bss_seg(".ble_qiot_llsync_event.data.bss")
#pragma data_seg(".ble_qiot_llsync_event.data")
#pragma const_seg(".ble_qiot_llsync_event.text.const")
#pragma code_seg(".ble_qiot_llsync_event.text")
#endif
/*
