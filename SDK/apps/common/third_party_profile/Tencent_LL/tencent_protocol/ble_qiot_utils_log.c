...
#pragma bss_seg(".ble_qiot_utils_log.data.bss")
#pragma data_seg(".ble_qiot_utils_log.data")
#pragma const_seg(".ble_qiot_utils_log.text.const")
#pragma code_seg(".ble_qiot_utils_log.text")
#endif
/*
