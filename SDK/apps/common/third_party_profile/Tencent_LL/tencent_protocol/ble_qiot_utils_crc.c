...
#pragma bss_seg(".ble_qiot_utils_crc.data.bss")
#pragma data_seg(".ble_qiot_utils_crc.data")
#pragma const_seg(".ble_qiot_utils_crc.text.const")
#pragma code_seg(".ble_qiot_utils_crc.text")
#endif
/*
