...
#pragma bss_seg(".ble_qiot_llsync_data.data.bss")
#pragma data_seg(".ble_qiot_llsync_data.data")
#pragma const_seg(".ble_qiot_llsync_data.text.const")
#pragma code_seg(".ble_qiot_llsync_data.text")
#endif
/*
