...
#pragma bss_seg(".ble_qiot_utils_hmac.data.bss")
#pragma data_seg(".ble_qiot_utils_hmac.data")
#pragma const_seg(".ble_qiot_utils_hmac.text.const")
#pragma code_seg(".ble_qiot_utils_hmac.text")
#endif
/*
