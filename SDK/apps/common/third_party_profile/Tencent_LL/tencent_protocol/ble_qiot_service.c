...
#pragma bss_seg(".ble_qiot_service.data.bss")
#pragma data_seg(".ble_qiot_service.data")
#pragma const_seg(".ble_qiot_service.text.const")
#pragma code_seg(".ble_qiot_service.text")
#endif
/*
