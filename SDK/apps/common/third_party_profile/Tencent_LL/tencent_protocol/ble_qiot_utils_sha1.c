...
#pragma bss_seg(".ble_qiot_utils_sha1.data.bss")
#pragma data_seg(".ble_qiot_utils_sha1.data")
#pragma const_seg(".ble_qiot_utils_sha1.text.const")
#pragma code_seg(".ble_qiot_utils_sha1.text")
#endif
/*
