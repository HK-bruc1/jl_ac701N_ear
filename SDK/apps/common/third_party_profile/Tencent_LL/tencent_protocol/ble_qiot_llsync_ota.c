...
#pragma bss_seg(".ble_qiot_llsync_ota.data.bss")
#pragma data_seg(".ble_qiot_llsync_ota.data")
#pragma const_seg(".ble_qiot_llsync_ota.text.const")
#pragma code_seg(".ble_qiot_llsync_ota.text")
#endif
/*
