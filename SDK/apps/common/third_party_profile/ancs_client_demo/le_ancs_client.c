...
#pragma bss_seg(".le_ancs_client.data.bss")
#pragma data_seg(".le_ancs_client.data")
#pragma const_seg(".le_ancs_client.text.const")
#pragma code_seg(".le_ancs_client.text")
#endif
/*********************************************************************************************
