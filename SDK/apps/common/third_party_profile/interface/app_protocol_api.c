...
#pragma bss_seg(".app_protocol_api.data.bss")
#pragma data_seg(".app_protocol_api.data")
#pragma const_seg(".app_protocol_api.text.const")
#pragma code_seg(".app_protocol_api.text")
#endif
#include <stdlib.h>
#include <string.h>
#include <unistd.h>
