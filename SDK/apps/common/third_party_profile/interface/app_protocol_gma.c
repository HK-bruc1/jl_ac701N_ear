...
#pragma bss_seg(".app_protocol_gma.data.bss")
#pragma data_seg(".app_protocol_gma.data")
#pragma const_seg(".app_protocol_gma.text.const")
#pragma code_seg(".app_protocol_gma.text")
#endif
#include <stdlib.h>
#include <string.h>
#include <unistd.h>
