...
//ADT_RESULT | WIND_MSCOHERE | WIND_CORR | WIND_PWR_ERR_REF;//WIND_MIC_DATA
const u8 DEBUG_ADT_WIND_EN  = 0;//ADT_RESULT;
const u8 DEBUG_ADT_ENVNL_EN = 0;//ADT_RESULT;
const u8 DEBUG_ADT_VDT_EN   = 0;
//==============================================//
//    通用配置
//==============================================//
...
const u8 final_speech_even_thr_env_T = 6;
...
const u8 angle_talk_even_flag0_thr_T = 4; //angle_tlk

const u8 angle_err_even_flag0_thr = 3;//4;  //angle_err
const u16 f1f2_angsum_thr = 400;
...
const float wat_bypass_gain = 18;//6;
