...
#pragma bss_seg(".lp_touch_key_alog.data.bss")
#pragma data_seg(".lp_touch_key_alog.data")
#pragma const_seg(".lp_touch_key_alog.text.const")
#pragma code_seg(".lp_touch_key_alog.text")
#endif
