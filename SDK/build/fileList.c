...
objs += \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/apps/tuyaos_demo_ble_peripheral/src/app_dp_parser.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/apps/tuyaos_demo_ble_peripheral/src/app_key.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/apps/tuyaos_demo_ble_peripheral/src/app_led.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/apps/tuyaos_demo_ble_peripheral/src/app_product_test.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/apps/tuyaos_demo_ble_peripheral/src/tuya_ble_protocol_callback.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/apps/tuyaos_demo_ble_peripheral/src/tuya_sdk_callback.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/apps/tuyaos_demo_ble_peripheral/src/tuya_app_func.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/apps/tuyaos_demo_ble_peripheral/src/tuya_sys_event.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/apps/tuyaos_demo_ble_peripheral/src/tuya_ota.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/app_tuya_driver/src/tal_adc.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/app_tuya_driver/src/tal_gpio.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/app_tuya_driver/src/tal_i2c.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/app_tuya_driver/src/tal_pwm.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/app_tuya_driver/src/tal_spi.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_app_passthrough/src/tal_ble_app_passthrough.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_attach_ota/src/tuya_ble_attach_ota.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_attach_ota/src/tuya_ble_attach_ota_port.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_beacon/src/tal_ble_beacon.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_bulkdata/src/tuya_ble_bulkdata.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_bulkdata/src/tuya_ble_bulkdata_demo.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_file/src/tal_ble_file.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_iot_channel/src/tuya_ble_iot_channel.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_ota/src/tuya_ble_ota.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_product_test/src/tal_gpio_test.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_product_test/src/tuya_ble_product_test.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_product_test/src/tuya_ble_product_test_over_air.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_protocol/src/tuya_ble_api.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_protocol/src/tuya_ble_data_handler.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_protocol/src/tuya_ble_event.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_protocol/src/tuya_ble_event_handler.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_protocol/src/tuya_ble_feature_accessory.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_protocol/src/tuya_ble_gatt_send_queue.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_protocol/src/tuya_ble_main.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_protocol/src/tuya_ble_mem.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_protocol/src/tuya_ble_mutli_tsf_protocol.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_protocol/src/tuya_ble_port.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_protocol/src/tuya_ble_queue.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_protocol/src/tuya_ble_storage.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_scene/src/tuya_ble_scene.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_uart_common/src/tuya_ble_uart_common.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_ble_weather/src/tuya_ble_weather.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_bluetooth/src/tal_bluetooth.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_driver/src/tal_flash.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_driver/src/tal_rtc.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_driver/src/tal_uart.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_driver/src/tal_watchdog.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_feature_ext_module/src/tal_ble_x_demo.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_feature_ext_module/src/tal_feature_ext_module.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_key/src/tal_key.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_local_timer/src/tal_local_timer.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_local_timer/src/tal_local_timer_storage.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_oled/src/tal_oled.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_repeater/src/tal_repeater.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_sdk_test/src/tal_sdk_test.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_system/src/tal_log.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_system/src/tal_memory.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_system/src/tal_ota.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_system/src/tal_sleep.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_system/src/tal_sw_timer.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_system/src/tal_system.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_utc/src/tal_utc.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/components/tal_util/src/tal_util.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/vendor/jl_ble/tuyaos/bluetooth/tkl_bluetooth.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/vendor/jl_ble/tuyaos/drivers/tkl_adc.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/vendor/jl_ble/tuyaos/drivers/tkl_flash.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/vendor/jl_ble/tuyaos/drivers/tkl_gpio.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/vendor/jl_ble/tuyaos/drivers/tkl_i2c.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/vendor/jl_ble/tuyaos/drivers/tkl_pwm.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/vendor/jl_ble/tuyaos/drivers/tkl_rtc.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/vendor/jl_ble/tuyaos/drivers/tkl_spi.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/vendor/jl_ble/tuyaos/drivers/tkl_uart.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/vendor/jl_ble/tuyaos/drivers/tkl_watchdog.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/vendor/jl_ble/tuyaos/system/tkl_memory.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/vendor/jl_ble/tuyaos/system/tkl_ota.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/vendor/jl_ble/tuyaos/system/tkl_sleep.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/vendor/jl_ble/tuyaos/system/tkl_system.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/vendor/jl_ble/tuyaos/system/tkl_thread.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/vendor/jl_ble/tuyaos/system/tkl_queue.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/vendor/jl_ble/tuyaos/system/tkl_wakeup.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/vendor/jl_ble/tuyaos/utilities/tuya_list.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/vendor/jl_ble/tuyaos/utilities/tuya_mem_heap.o \
    $(ROOT)/apps/common/third_party_profile/tuyaos_protocol/TuyaOS/vendor/jl_ble/tuyaos/utilities/tuya_queue.o \
...
#ifdef CONFIG_SOUNDBOX_CASE
objs += \
      $(ROOT)/cpu/br28/ui_driver/led7/led7_driver.o \
      $(ROOT)/cpu/br28/ui_driver/ui_common.o
#endif
...
#if EXPORT_LCD_DRIVER_ENABLE

objs += \
    $(ROOT)/cpu/$(CPU_DIR)/ui_driver/interface/ui_platform.o
objs += \
    $(ROOT)/cpu/$(CPU_DIR)/ui_driver/lcd_drive/lcd_drive.o
objs += \
    $(ROOT)/cpu/$(CPU_DIR)/ui_driver/lcd_drive/lcd_spi/lcd_spi_st7789v_240x240.o
objs += \
    $(ROOT)/cpu/$(CPU_DIR)/ui_driver/lcd_drive/lcd_spi/lcd_spi_sh8601a_454x454.o
objs += \
    $(ROOT)/cpu/$(CPU_DIR)/ui_driver/lcd_drive/lcd_spi/lcd_spi_gc9b71_320x386.o
